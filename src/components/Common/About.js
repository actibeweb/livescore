              ...
              <div className="row">
                ...
                <div className="col-lg-7">
                  <h4 className="subtitle" style={{ color: "#FF8A00" }}>
                    <span style={{fontSize:"2rem"}} >{ details && details.headingMain}</span>
                    {details && details.headingOne}
                  </h4>
                  <p>
                    {details && details.contentOne}
                  </p>
                  <div className="row">
                    <div className="col-lg-6">
                      <h5 style={{ color: "#FF8A00" }}>{details && details.headingTwo}</h5>
                      <p>
                      {details && details.contentTwo}
                      </p>
                    </div>
